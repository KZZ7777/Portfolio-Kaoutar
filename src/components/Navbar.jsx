    ...
    return (
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <a href="/">
                    <img src="./assets/light_logo.png" alt="Light_Logo" className="w-28 cursor-pointer mr-14 dark:hidden" />
                    <img src="./assets/logo.png" alt="Logo" className="w-28 cursor-pointer mr-14 hidden dark:block" />
                </a>
                ...
                <ul ref={navLinkRef} className="hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 bg-white shadow-sm bg-opacity-50 font-Ovo dark:border dark:border-white/30 dark:bg-transparent ">
                    ...
                    <li><a className='hover:text-gray-500 dark:hover:text-gray-300 transition' href="/#internship">Internship</a></li>
